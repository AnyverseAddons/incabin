...
incabin_config = {
    ...
    "occupancy_distribution": {
        ...
        'object_types': ['Backpack', 'briefcase', 'Consumer_electronics', 'Dog', 'duffle' 'Handbag', 'laptop_case' 'Mobile Phone', 'Paper_Bag', 'Snack', 'garbage bag', 'paper_bag', 'plastic bag', 'snack', 'wallet'],
