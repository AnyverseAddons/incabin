...
class InCabinUtils:
    def __init__(self, workspace, resources, script_console, iteration_index = None, total_iteration_count = None):
        self._iteration_index = iteration_index
        self._total_iteration_count = total_iteration_count
        self._workspace = workspace
        self._resources = resources
        self._no_entry = anyverse_platform.invalid_entity_id
        self._ego_id = self._workspace.get_entities_by_name("Ego")[0]
        self._already_used_characters = ['rp_fabienne_rigged_001_OP','rp_toshiro_rigged_007_OP','rp_sheila_rigged_002_OP','rp_toshiro_rigged_003_OP','rp_debra_rigged_001_OP','rp_toshiro_rigged_008_OP','rp_bianca_rigged_001_OP','rp_amit_rigged_003_OP'] # HACK trying to avoid these characters
        self._car_brand = ""
        self._car_model = ""
    ...
    def selectObject(self, name = None, version = None, big_object = None):
        ...
        picked_object['entity_id'] = object_asset_id
    ...
    def selectHumanAccessory(self, type, values, name = None):
        ...
        if len(filtered_accessories) > 0:
            ...
            picked_accessory['entity_id'] = object_asset_id
        else:
            picked_accessory = {}
    ...
    def placeObject(self, seat_locator, name = None, version = None):
        print('[INFO] Placing object in {}'.format(self._workspace.get_entity_name(seat_locator).split('_')[0]))
    ...
    def placeDriver(self, seat_locator, name = None, seatbelts_distribution = None, accessories_probabilities = None, expression_probabilities = None):
        ...
        if driver_asset_id != -1:
            ...
            self._already_used_characters.append(driver['resource_name'])
        else:
    ...
    def selectChildseat(self, key, value, orientation = None, name = None):
        ...
        if len(filtered_childseats) > 0:
            ...
            childseat['entity_id'] = childseat_asset_id
        else:
    ...
    def placeBabyInChildseat(self, childseat, seat_locator, name = None):
        ...
        if len(childseat_locators) == 1:
            ...
            print('[ERROR] Child seat missing child or childseat locator with format child.*_locator$ {}'.format(childseat_locators))
            assert False
        ...
        self._already_used_characters.append(baby['resource_name'])
    ...
    def placePassenger(self, seat_locator, name = None, seatbelts_distribution = None, accessories_probabilities = None, expression_probabilities = None, children = False):
        ...
        if passenger_found:
            ...
            self._already_used_characters.append(passenger['resource_name'])
    ...
    def setSeatInfo(self, character):
        ...
        try:
            ...
            print('[INFO] It is a child seat, no seatbelt_on info')
...
#_______________________________________________________________
    ...
    def setSeat(self, the_car, seats, seat_locators, seat_num, color_scheme = None, move_seats_conf = None):
        ...
        if locator != None:
            ...
            if seat != None:
                ...
                print("[WARN] Locator {} exists but not its seat".format(self._workspace.get_entity_name(locator)) )
    ...
    def setCarSeatbeltsOff(self, picked_car):
        ...
        for belt in belts:
            beltoff_asset_id = self._workspace.add_resource_to_workspace(anyverse_platform.WorkspaceEntityType.Asset, belt['resource_id'])
            beltoff_id = self._workspace.create_fixed_entity(belt['resource_name'], belt_locator, beltoff_asset_id)
